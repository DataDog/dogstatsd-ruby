...
A version 4.9.0 containing changes intended for 5.0.0 (with API breaking changes) has been released and was available during the 2021-03-23.
It has been removed on the 2021-03-24 and is not available anymore: v4.8.x should be used for latest v4 version of the gem, upcoming v5.x.x version should be used to benefit of the latest performances improvements.
