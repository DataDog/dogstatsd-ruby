...
The message queue's maximum size is given by the `sender_queue_size` argument, and has appropriate defaults for UDP (2048) and UDS (512).

```ruby
statsd = Datadog::Statsd.new('localhost', 8125, sender_queue_size: 128)
```
