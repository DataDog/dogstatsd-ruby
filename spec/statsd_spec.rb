...
describe Datadog::Statsd do
  ...
  describe '#gauge' do
    ...
    it 'sends the gauge with sequential values' do
      ...
      expect(socket.recv[0]).to eq_with_telemetry 'begrutten-suffusion:-107.3|g', bytes_sent: 909, packets_sent: 1
    end
  ...
  describe '#histogram' do
    ...
    it 'sends the histogram with sequential values' do
      ...
      expect(socket.recv[0]).to eq_with_telemetry 'ohmy:-107.3|h', bytes_sent: 894, packets_sent: 1
    end
